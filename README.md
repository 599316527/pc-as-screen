...
`pc-as-screen` is a minimal MVP that lets a Windows machine act as a software-only external display receiver for macOS over a LAN.
...
- audio transport
- keyboard or mouse input return
...
See [docs/private-api-and-limitations.md](/Users/bytedance/work/pc-as-screen/docs/private-api-and-limitations.md) and [docs/protocol.md](/Users/bytedance/work/pc-as-screen/docs/protocol.md) for the concrete operating constraints.
